                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            <div>
                                <h5 class="mb-4">Laporan Kas Besar</h5>
                            </div>
                    ...
                    <div class="container">
                        <form action="{{ route('besar.store') }}" method="POST">
                            @csrf
                            <div class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">
                                        {{ date('d-m-Y', strtotime($kasbesar->tanggal)) }}</p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">{{ $kasbesar->kategori }}</p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">{{ $kasbesar->keterangan }}
                                    </p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">Rp
                                        {{ number_format($kasbesar->nominal_transaksi, 0, '.', '.') }}</p>
                                </td>
                                <td class="text-center">
                                    ...
                                    <a href="#" class="mx-0" data-bs-toggle="tooltip"
                                        ...
                                        <form method="POST" action="{{ route('besar.delete', $kasbesar->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-link" style="padding: 0 10px;">
